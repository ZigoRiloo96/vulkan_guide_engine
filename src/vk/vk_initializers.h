...
command_pool_create_info(u32 queueFamilyIndex, VkCommandPoolCreateFlags flags = 0)
{
...
command_buffer_allocate_info(VkCommandPool pool, u32 count = 1, VkCommandBufferLevel level = VK_COMMAND_BUFFER_LEVEL_PRIMARY)
{
...
framebuffer_create_info(VkRenderPass renderPass, VkExtent2D extent)
{
...
VkImageCreateInfo
image_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent)
{
...
VkWriteDescriptorSet
write_descriptor_image(VkDescriptorType type, VkDescriptorSet dstSet, VkDescriptorImageInfo* imageInfo, u32 binding)
{
  VkWriteDescriptorSet write = {};
  write.sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
  write.pNext = nullptr;
...
buffer_barrier(VkBuffer buffer, uint32_t queue)
{
...
image_barrier(VkImage image, VkAccessFlags srcAccessMask, VkAccessFlags dstAccessMask, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectMask)
{
